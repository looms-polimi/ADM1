model SHMA
  ...
  Real S_h2(unit = "gCOD/L", fixed = true, start = S_h2_0) "Dissolved hydrogen concentration at time t = 0";
  ...
  Real S_nh3(unit = "mole/L", fixed = true, start = S_nh3_0) "Free ammonia concentration";
  ...
  parameter Real kLa_O2(unit = "d-1") = 750 "Oxygen gas-liquid mass transfer coefficient";
